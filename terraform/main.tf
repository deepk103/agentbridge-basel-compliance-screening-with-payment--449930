...
resource "aws_vpc" "main" {
  ...
  tags = {
    blueprint = "Basel Compliance Screening with Payment Hub"
    environment = "production"
    Name = "agentbridge-basel-compliance-screening-with-payment-"
    Environment = "production"
    ManagedBy = "terraform"
  }
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "agentbridge-basel-compliance-screening-with-payment--igw"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "agentbridge-basel-compliance-screening-with-payment--public"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "agentbridge-basel-compliance-screening-with-payment--rt"
  }
}
...
resource "aws_security_group" "main" {
  name_prefix = "agentbridge-basel-compliance-screening-with-payment--"
  vpc_id      = aws_vpc.main.id
  ...
  tags = {
    Name = "agentbridge-basel-compliance-screening-with-payment--sg"
  }
...
resource "aws_key_pair" "deploy" {
  ...
  key_name   = "agentbridge-basel-compliance-screening-with-payment-"
...
resource "aws_eip" "main" {
  ...
  domain   = "vpc"
  tags = {
    Name = "agentbridge-basel-compliance-screening-with-payment--eip"
  }
}
...
resource "aws_ebs_volume" "data" {
  ...
  encrypted         = true
  tags = {
    Name = "agentbridge-basel-compliance-screening-with-payment--data"
  }
}
...
resource "aws_iam_role" "bedrock_flow" {
  ...
  name  = "agentbridge-basel-compliance-screening-with-payment--bedrock-role"
...
resource "aws_iam_role" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-basel-compliance-screening-with-payment--ec2-bedrock"
...
resource "aws_iam_instance_profile" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-basel-compliance-screening-with-payment--ec2-profile"
...
resource "aws_bedrockagent_flow" "main" {
  count              = var.enable_bedrock ? 1 : 0
  name               = "agentbridge-basel-compliance-screening-with-payment--flow"
